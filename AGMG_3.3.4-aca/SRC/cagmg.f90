...
PRIVATE
PUBLIC :: cagmg_setupL1, cagmg_relmem,  cagmg_smoothsetup
PUBLIC :: cagmg_applyprec, cagmg_GCR, cagmg_FlexCG
PUBLIC :: cagmg_partroword
...
CONTAINS
  ...
  SUBROUTINE cagmg_partroword(n, a, ja, ia, idiag, iext, nzext)
    IMPLICIT NONE
  ...
  SUBROUTINE cagmg_FlexCG(N,f,X,ITER,RESID,a,ja,ia,ijb)
    ...
    IF (init) THEN
       ...
       IF (intmv) THEN
          ...
          ELSE
             CALL cagmg_mcsrmv(n,dt(1)%a,dt(1)%ja,n+1,dt(1)%il,x,1,f,-2,flop)
...
200 CONTINUE
  ...
  SUBROUTINE cagmg_setupL1(n,a,ja,ia)
    USE cagmg_mem
    IMPLICIT NONE
    INTEGER :: n
    INTEGER :: ja(*),ia(n+1)
...
958 FORMAT('****','              Weighted complexity:',f9.2)
  ...
  RECURSIVE SUBROUTINE cagmg_setup(l,n)
    USE cagmg_mem
    IMPLICIT NONE
    INTEGER :: l,n
...
924 FORMAT('****','        Number of variables:',i12)
  ...
  SUBROUTINE cagmg_aggregation(l,n,a,ja,ia,nc)
    USE cagmg_mem
    IMPLICIT NONE
    INTEGER :: l,n,nc
    INTEGER :: ja(*),ia(n+1)
...
1001 FORMAT(i3,'*',' FATAL ERROR: setup not done: ijob=',i3, &
 ...
 910 FORMAT(i3,'*ENTERING AGMG **********************************',&
    ...
    ELSE
      ...
      CALL cagmg_partroword(n,a,ja,ia,dt(1)%idiag)
      nza=ia(n+1)-ia(1)
      ALLOCATE(scald(n),ascaled(ia(n+1)-ia(1)))
      CALL cagmg_diagscal(n,a,ja,ia,dt(1)%idiag,ascaled)
      CALL cagmg_setupL1(n,ascaled,ja,ia)
      DEALLOCATE(ascaled)
