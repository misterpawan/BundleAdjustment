...
PRIVATE
PUBLIC :: dagmg_setupL1, dagmg_relmem,  dagmg_smoothsetup
PUBLIC :: dagmg_applyprec, dagmg_GCR, dagmg_FlexCG
PUBLIC :: dagmg_partroword
CONTAINS
    SUBROUTINE PARDISO( PT, MAXFCT, MNUM, MTYPE, PHASE, N, A, IA, JA    &
         , PERM, NRHS, IPARM, MSGLVL, B, X, ERROR )
      USE dagmg_PARDISSO
  ...
  SUBROUTINE dagmg_partroword(n, a, ja, ia, idiag, iext, nzext)
    IMPLICIT NONE
  ...
  SUBROUTINE dagmg_FlexCG(N,f,X,ITER,RESID,a,ja,ia,ijb)
    ...
    IF (init) THEN
       IF (intmv) THEN
          ...
          ELSE
             CALL dagmg_mcsrmv(n,dt(1)%a,dt(1)%ja,n+1,dt(1)%il,x,1,f,-2,flop)
...
200 CONTINUE
  ...
  SUBROUTINE dagmg_setupL1(n,a,ja,ia)
    USE dagmg_mem
    IMPLICIT NONE
    INTEGER :: n
    INTEGER :: ja(*),ia(n+1)
...
958 FORMAT('****','              Weighted complexity:',f9.2)
  ...
  RECURSIVE SUBROUTINE dagmg_setup(l,n)
    USE dagmg_mem
    IMPLICIT NONE
    INTEGER :: l,n
...
924 FORMAT('****','        Number of variables:',i12)
  ...
  SUBROUTINE dagmg_aggregation(l,n,a,ja,ia,nc)
    USE dagmg_mem
    IMPLICIT NONE
    INTEGER :: l,n,nc
    INTEGER :: ja(*),ia(n+1)
...
1001 FORMAT(i3,'*',' FATAL ERROR: setup not done: ijob=',i3, &
 ...
 910 FORMAT(i3,'*ENTERING AGMG **********************************',&
    ...
    ELSE
      ...
      CALL dagmg_partroword(n,a,ja,ia,dt(1)%idiag)
      nza=ia(n+1)-ia(1)
      CALL dagmg_setupL1(n,a,ja,ia)
